    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_tags', multiselectfield.db.fields.SortMultiSelectField(blank=True, choices=[('sex', 'Sex'), ('work', 'Work'), ('happy', 'Happy'), ('food', 'Food'), ('field', 'Field'), ('boring', 'Boring'), ('interesting', 'Interesting'), ('huge', 'Huge'), ('nice', 'Nice')], max_length=54, null=True)),
