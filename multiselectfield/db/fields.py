...
class MSFList(list):
    ...
    def __str__(msgl):
        msf_l = [msgl.choices.get(int(i)) if i.isdigit() else msgl.choices.get(i) for i in msgl]
        return u', '.join([string_type(s) for s in msf_l])
...
class MultiSelectField(models.CharField):
    ...
    def _get_flatchoices(self):
        msf_l = super(MultiSelectField, self)._get_flatchoices()
